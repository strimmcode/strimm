#include "SimpleProtocolSoftwareTiming.h"
#include "ProtocolBase.h"



void SimpleProtocolSoftwareTiming::con(int in, int x, int y)
{
	HDC dc = GetDC(NULL);
	char buff[100] = { 0 };
	_ltoa_s(in, buff, 10);
...
void SimpleProtocolSoftwareTiming::con(string in, int x, int y)
{
	HDC dc = GetDC(NULL);
	TextOutA(dc, x, y, "            ", 7);
...
SimpleProtocolSoftwareTiming::SimpleProtocolSoftwareTiming(int deviceID, double minV, double maxV) {
	bContinuous = false;
...
SimpleProtocolSoftwareTiming::~SimpleProtocolSoftwareTiming() {
...
bool	SimpleProtocolSoftwareTiming::Init(char* szCsv) {
	//load the simple protocol from the text file szCsv
	//
	//TODO rewrite this section with the new format
...
bool	SimpleProtocolSoftwareTiming::UpdateAOChannel(double* pData, int channel) {
...
bool	SimpleProtocolSoftwareTiming::UpdateDOChannel(uInt32* pData, int line) {
...
bool	SimpleProtocolSoftwareTiming::InitDAQ() {
	/*
...
bool	SimpleProtocolSoftwareTiming::RunProtocolDAQ(double* pTimeSec, double* pDataAO, double* pDataAI, uInt32* pDataDO, uInt32* pDataDI, bool bStartTrigger, bool bRisingEdge, uInt32 pFIx, double timeoutSec) {
	/*
...
bool	SimpleProtocolSoftwareTiming::ReleaseDAQ() {
...
double	SimpleProtocolSoftwareTiming::GetCurrentRunSampleTime() {


	return 1000.0 / sampleFreq; // in ms
}

double	SimpleProtocolSoftwareTiming::GetSampleFreq() {
	return sampleFreq;
}


int		SimpleProtocolSoftwareTiming::GetNumChannels(int type) {
	if (type == 0) {
		//ao
...
int		SimpleProtocolSoftwareTiming::GetIndexFromChannel(int type, int ch) {
	if (type == 0) {
...
int		SimpleProtocolSoftwareTiming::GetChannelFromIndex(int type, int ix) {
	if (type == 0) {
...
int		SimpleProtocolSoftwareTiming::GetPort(bool bIn) {
	if (bIn) {
		return DIPort;
	}
	else {
...
int		SimpleProtocolSoftwareTiming::GetDeviceID() {
	return deviceID;
}

int		SimpleProtocolSoftwareTiming::GetNumSamples() {
	return numSamples;
}
int		SimpleProtocolSoftwareTiming::GetNumAOChannels() {
	return numAOChannels;
}
int		SimpleProtocolSoftwareTiming::GetNumAIChannels() {
	return numAIChannels;
}
int		SimpleProtocolSoftwareTiming::GetNumDOChannels() {
	return numDOChannels;
}
int		SimpleProtocolSoftwareTiming::GetNumDIChannels() {
	return numDIChannels;
}