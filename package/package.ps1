...
$Files = 
    ...
    "$env:USERPROFILE/.m2/repository/uk/co/strimm/AnchorFX/1.0.0/AnchorFX-1.0.0.jar",
...
copyMavenJar -Location "../target" -Name "STRIMM"

copyFolderContents -From "../DeviceAdapters" -To "$OutputDir/DeviceAdapters"
copyFolderContents -From "../ExperimentConfigurations" -To "$OutputDir/ExperimentConfigurations"
copyFolderContents -From "../logo" -To "$OutputDir/logo"

Write-Host "Copying loose files" -ForegroundColor Cyan
copyFile -From "../MMCoreJ_wrap.dll" -To "$OutputDir"
copyFile -From "../Test.dll" -To "$OutputDir"
