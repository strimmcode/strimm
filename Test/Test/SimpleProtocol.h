...
public:
	...
	*/
	SimpleProtocol(int deviceID, double minV, double maxV, string szDeviceName);
	/*
	...
	*/
	...
	bool DAQRunThread(double* pTimeSec, double* pDataAO, double* pDataAI, uInt32* pDataDO, uInt32* pDataDI, bool bStartTrigger, bool bRisingEdge, uInt32 pFIx, double timeoutSec);
...
private:
	...
	bool bDirtyAO, bDirtyDO, bError, bStartTrigger;
	int deviceID;
	string szDeviceName;
	double minV, maxV;
	uInt32 pFIx;
