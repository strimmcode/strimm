...
open class SimpleXYStagePositionsSource() : SourceMethod {
...
//        tim.add(kotlin.Pair(this.source.sourceName, GUIMain.softwareTimerService.getTime()))
        ...
        var pos = listOf<Double>(dataID.toDouble(), dataID.toDouble()+1.0)

        return STRIMMXYStageBuffer("setXYPosition", pos, dataID, 1 )
    }
