...
class MMCoreService : AbstractService(), ImageJService {
    ...
    companion object {
        ...
        var deviceAdapterSearchPaths
            ...
            set(value) {
                core.deviceAdapterSearchPaths = StrVector().apply { value.forEach(::add) }
            }
    }

    fun initForTests() {
        deviceAdapterSearchPaths = listOf(DEVICE_ADAPTERS_FOLDER)
...
data class MMDeviceDesc(val name: String, val description: String, val type: Int)
sealed class MMDeviceLibrary {
